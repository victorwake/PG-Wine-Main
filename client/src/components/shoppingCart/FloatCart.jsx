...
export const FloatCart = ({ image, name, color_type, varietal , winery, price, id }) => {//se lo paso por props
    ...
    {cart?.map((item) => (
        <tr>
          ...
          <td>     <input
            ...
            /></td>
          <td>  <button onClick={() => dispatch(removeFromCart(item.id)) }>X</button></td>
         <td>   <h4 className="price-card-">{item.price * item.quantity} $</h4></td>
