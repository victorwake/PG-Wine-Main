                ...
                <div>
                    <form className='form' onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <div>
                            ...
                            <select id='varietal' name='varietal' onChange={(e)=> handleVarietal(e)}>
                    ...
                    <div>
                        <button disabled={disabled} className='submit' type='submit'>CREAR</button>
                        <button disabled={disabled} onClick={handleSubmitUpdate} className = {id ? 'submit' : 'hide'}> ACTUALIZAR</button>
                    </div>
                    </form>
