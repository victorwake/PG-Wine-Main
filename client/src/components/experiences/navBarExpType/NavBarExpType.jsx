...
export const NavBarExpType = () => {
  ...
  return (
    ...
    <Fragment >
      ...
      <Link to={"/experiencias/" + "hoteles"}  style={{ color: "inherit", textDecoration: "inherit" }}>
      ...
      <div class="card-wrapper">
      <Link to={"/experiencias/" + "visitas guiadas"}  style={{ color: "inherit", textDecoration: "inherit" }}>
