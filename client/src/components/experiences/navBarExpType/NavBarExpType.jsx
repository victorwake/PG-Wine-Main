...
export const NavBarExpType = () => {
  ...
  return (
    ...
    <Fragment >
      ...
      <Link to={"/experiencias/" + "tinto"}  style={{ color: "inherit", textDecoration: "inherit" }}>
      ...
      <div class="card-wrapper">
      <Link to={"/experiencias/" + "blanco"}  style={{ color: "inherit", textDecoration: "inherit" }}>
      ...
      <div class="card-wrapper">
      <Link to={"/experiencias/" + "rosado"}  style={{ color: "inherit", textDecoration: "inherit" }}>
      ...
      <div class="card-wrapper">
      <Link to={"/experiencias/" + "espumante"}  style={{ color: "inherit", textDecoration: "inherit" }}>
