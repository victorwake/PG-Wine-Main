...
export const ExpCard = ({ name, price, kindOfExp, image, url, description }) => {
...
<div className="carousel">
        ...
        <div>
          <h3 className={'type-exp-card-' + clase}>{kindOfExp} </h3>
        </div>
        <div>
          <h6 className={'description-exp-card' + clase}> {description} </h6>  
        </div>
        <div>
          <h3 className={'price-card-' + clase}>$ {price} </h3>
        </div>
        <div>
